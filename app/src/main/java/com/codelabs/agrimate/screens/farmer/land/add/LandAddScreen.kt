package com.codelabs.agrimate.screens.farmer.land.add
...
fun LandAddScreen(
    ...
    viewModel: LandAddViewModel = hiltViewModel(),
...
fun LandAddContent(
    ...
    Column(
        ...
        Column(
            ...
            AGInputLayout(label = "Provinsi", isRequired = true) {
            ...
            AGInputLayout(label = "Kota", isRequired = true) {
                AGSelectInputWithSearch(
                    modifier = Modifier.fillMaxWidth(),
            ...
            AGInputLayout(label = "Kecamatan", isRequired = true) {
                AGSelectInputWithSearch(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    onValueChange = {
                        ...
                        val location = geocoder.getFromLocationName(
                            "$it.label ${uiState.city} ${uiState.province}",
                            1
                        )?.get(0)
                        if (location != null) {
                            coroutineScope.launch {
            ...
            AGInputLayout(label = "Kelurahan", isRequired = true) {
                AGSelectInputWithSearch(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    onValueChange = {
                        ...
                        val location = geocoder.getFromLocationName(
                            "$it ${uiState.district} ${uiState.city} ${uiState.province}",
                            1
                        )?.get(0)
                        if (location != null) {
                            coroutineScope.launch {
            ...
            AGInputLayout(label = "Tandai Lahan", isRequired = true) {
            ...
            AGInputLayout(label = "Luas Tanah", isRequired = true) {
                AGInputWithSuffix(
            ...
            AGInputLayout(label = "Alamat lengkap", isRequired = true) {
                AGInputFullAddress(
                    modifier = Modifier.fillMaxWidth(),
            ...
            AGInputLayout(label = "Gambar Lahan", isRequired = true) {
                AGInputImage(
                    modifier = Modifier.fillMaxWidth(),
