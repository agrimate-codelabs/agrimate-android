...
private fun SignupContent(
    ...
    onRoleChange: (ProfessionSelectInputImpl) -> Unit,
    ...
    Column(
        ...
        AGAuthTopBanner(title = "Daftar Akun")
        ...
        Column(
            ...
            AGInputLayout(modifier = Modifier.fillMaxWidth(), label = "Nama", isRequired = true) {
                AGInputId(
            ...
            AGInputLayout(
                ...
                AGSelectInputWithSearch(
                    ...
                    onValueChange = {
                        onRoleChange(ProfessionSelectInputImpl(it.label, it.value))
                    },
                    label = "Status",
                    placeholder = "Pilih Status",
                    options = uiState.listOfProfession,
                    isError = !uiState.inputRole.isValid,
                    supportingText = if (!uiState.inputRole.isValid) {
                        { Text(text = uiState.inputRole.message) }
                    } else null
                )
            }
            AGInputLayout(
            ...
            AGInputLayout(modifier = Modifier.fillMaxWidth(), label = "Kota", isRequired = true) {
                AGSelectInputWithSearch(
                    modifier = Modifier.fillMaxWidth(),
